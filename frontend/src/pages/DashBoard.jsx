...
function Sidebar({ aoSair }) {
    ...
    return (
        <aside className="sidebar">
            ...
            <nav>
                <a onClick={() => navigate('/dashboard')} className="active" style={{ cursor: 'pointer' }}>Dashboard</a>
                <a onClick={() => navigate('/investimentos')} style={{ cursor: 'pointer' }}>Investimentos</a>
                <a onClick={() => navigate('/relatorios')} style={{ cursor: 'pointer' }}>Relatórios</a>
            ...
            <div className="content">
                ...
                <section className="summary">
                    <div className="left">
                        ...
                        <div className="acc">Baseado em <strong>{summary.activesCount}</strong> ativos encontrados no banco.</div>
                    </div>
                    <div className="right">
                ...
                <section className="widgets">
                    <div className="widget">
                        <div className="pie" style={{ fontSize: '2rem', color: '#2f8a2f', fontWeight: 'bold' }}>+12%</div>
                        <div>Rentabilidade Mensal</div>
                    </div>
                    <div className="widget">
                        <div className="donut" style={{ fontSize: '2rem' }}>📊</div>
